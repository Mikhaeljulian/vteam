...
<Embed src="https://stackblitz.com/edit/react-ts-mtbzp4?embed=1&file=App.tsx" />
...
The entirety of this website is styled using these techniques, so if you want to see an example of how this applies to some real components.  